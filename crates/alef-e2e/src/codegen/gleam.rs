        ...
        if !any_tests {
            let smoke = format!(
                "// Generated by alef. Do not edit by hand.\n\
                 ...
                 // This file verifies the package compiles and its module is importable.\n\
                 import gleeunit\n\
                 ...
                 pub fn package_compiles_test() {{\n\
                   let _config = {pkg_name}.schema_query_only()\n\
                   True |> should.equal(True)\n\
                 }}\n"
            );
            files.push(GeneratedFile {
                path: output_base.join("test").join("smoke_test.gleam"),
                content: smoke,
                generated_header: false,
            });
        }
