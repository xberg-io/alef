...
static TEMPLATES: &[(&str, &str)] = &[
    ...
    (
        ...
        include_str!("../templates/init_all_entry.jinja"),
    ),
    (
    ...
    (
        "stub_return_sig.jinja",
        include_str!("../templates/stub_return_sig.jinja"),
    ),
    (
    ...
    (
        ...
        include_str!("../templates/enum_docstring.jinja"),
    ),
    ...
    (
        ...
        include_str!("../templates/class_docstring.jinja"),
    ),
    (
    ...
    (
        ...
        include_str!("../templates/typeddict_field.jinja"),
    ),
    (
