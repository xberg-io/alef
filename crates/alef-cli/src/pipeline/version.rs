use alef_core::config::{CitationAuthor, CitationConfig, Language, ResolvedCrateConfig};
...
mod tests {
    ...
    fn citation_author_person() -> CitationAuthor {
        CitationAuthor {
            ...
            name: None,
            email: Some("naaman@kreuzberg.dev".to_string()),
    ...
    fn citation_author_entity() -> CitationAuthor {
        CitationAuthor {
            family_names: None,
            given_names: None,
            name: Some("Kreuzberg, Inc.".to_string()),
            email: None,
            orcid: None,
        }
    }
    ...
    fn citation_config_mit() -> CitationConfig {
        CitationConfig {
            title: "html-to-markdown".to_string(),
            abstract_: "Fast HTML to Markdown converter.".to_string(),
            authors: vec![citation_author_person()],
            message: "If you use this software, please cite it using the metadata below.".to_string(),
            repository_code: "https://github.com/kreuzberg-dev/html-to-markdown".to_string(),
            url: Some("https://kreuzberg.dev".to_string()),
...
abstract: "Fast HTML to Markdown converter."
authors:
...
"#;
    ...
    fn render_citation_cff_elv2_with_entity_author() {
        ...
        config.title = "kreuzberg".to_string();
        config.repository_code = "https://github.com/kreuzberg-dev/kreuzberg".to_string();
        ...
        assert!(rendered.contains("  - name: \"Kreuzberg, Inc.\"\n"));
