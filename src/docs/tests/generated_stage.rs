...
"#,
    ...
    let llms = files.iter().find(|file| file.path == *"docs/llms.txt").unwrap();
    ...
    let cli_doc = files.iter().find(|file| file.path == *"docs/reference/cli.md").unwrap();
    ...
    let api_doc = files
        .iter()
        .find(|file| file.path == *"docs/reference/api-python.md")
        .unwrap();
