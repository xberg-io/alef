...
fn gen_single_trait_bridge_file(
    ...
    // NOTE: Registration functions are NOT emitted here. They live in Kreuzberg.swift
...
mod tests {
    ...
    /// function. Registration is handled by `emit_trait_bridge_forwarders` in `Kreuzberg.swift`
    ...
    fn test_no_register_fn_in_trait_bridge_file() {
        ...
        // in Kreuzberg.swift and uses SwiftDocumentExtractorBox (not Adapter).
        assert!(
