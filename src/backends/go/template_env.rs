...
static TEMPLATES: &[(&str, &str)] = &[
    ...
    (
        "duration_millis_type.jinja",
        include_str!("templates/duration_millis_type.jinja"),
    ),
...
mod template_registration_tests {
    ...
    fn every_template_file_is_registered() {
        let templates_dir = Path::new(concat!(env!("CARGO_MANIFEST_DIR"), "/src/backends/go/templates"));
