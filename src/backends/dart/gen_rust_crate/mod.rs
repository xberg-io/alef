...
use crate::core::config::{AdapterConfig, AdapterPattern, Language, ResolvedCrateConfig, resolve_output_dir};
...
fn emit_lib_rs(
    ...
    {
        content.push('\n');
        enum_conversions::emit_from_impl_for_enum(
            &mut content,
            en,
            source_crate_name,
            Some(configured_features.as_slice()),
    ...
    {
        content.push('\n');
        enum_conversions::emit_from_mirror_to_core_enum(
            &mut content,
            en,
            source_crate_name,
            Some(configured_features.as_slice()),
