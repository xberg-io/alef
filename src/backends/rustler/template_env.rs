...
"#,
  ...
  use RustlerPrecompiled,
    ...
    force_build:
      System.get_env("{{ build_env_var }}") in ["1", "true"] or Mix.env() in [:dev]
...
"#,
    ...
    ("bytes_to_vec.rs.jinja", include_str!("templates/bytes_to_vec.rs.jinja")),
    (
    ...
    ("rustler_init.rs.jinja", include_str!("templates/rustler_init.rs.jinja")),
    (
