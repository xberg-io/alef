...
fn has_ref_named_params(params: &[crate::core::ir::ParamDef], opaque_types: &AHashSet<String>) -> bool {
    params
        .iter()
...
fn has_sanitized_recoverable(params: &[crate::core::ir::ParamDef]) -> bool {
    params.iter().any(|p| {
        p.sanitized
