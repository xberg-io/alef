...
pub(super) fn emit_websocket_routes(routes: &[crate::core::ir::WebSocketRouteDef]) -> String {
    ...
    tracing::debug!(
        "WebSocket route emission not implemented for zig ({} routes)",
        routes.len()
    );
...
pub(super) fn emit_sse_routes(routes: &[crate::core::ir::SseRouteDef]) -> String {
    ...
    tracing::debug!("SSE route emission not implemented for zig ({} routes)", routes.len());
    for _route in routes {}
    String::new()
}
...
pub(super) fn emit_error_types(types: &[crate::core::ir::ErrorTypeDef]) -> String {
    ...
    tracing::debug!("error type emission not implemented for zig ({} types)", types.len());
    for _ty in types {}
    String::new()
}
