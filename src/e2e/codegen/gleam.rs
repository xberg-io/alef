...
///
/// `pkg_module` is the binding's Gleam module name (resolved from
...
fn render_tagged_union_assertion(
    ...
    // The binding's Gleam module — used as the qualifier for the
...
pub fn emit_test_backend(
    ...
    super::TestBackendEmission::unimplemented("gleam")
}
