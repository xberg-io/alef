...
use crate::e2e::escape::{escape_gleam, sanitize_filename, sanitize_ident};
...
fn render_gleam_toml(pkg_path: &str, pkg_name: &str, dep_mode: crate::e2e::config::DependencyMode) -> String {
