...
use crate::e2e::codegen::select_best_matching_call;
...
pub(super) fn render_test_case(
    ...
    call_config = select_best_matching_call(call_config, e2e_config, fixture);
...
pub(super) fn has_later_arg_value(args: &[ArgMapping], from_idx: usize, input: &serde_json::Value) -> bool {
...
pub(super) fn has_bytes_file_reads(input: &serde_json::Value, args: &[ArgMapping]) -> bool {
    args.iter().any(|arg| {
...
pub(super) fn has_trait_bridge_args(args: &[ArgMapping]) -> bool {
