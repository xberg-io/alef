...
- **alef-codegen: omit binding-excluded fields from generated DTO surfaces**: shared struct generation, constructor helpers, Java, NAPI, PyO3, C#, Go, Magnus, PHP, and Rustler emitters now filter out `binding_excluded` fields while conversion code still defaults the hidden core fields when converting back to Rust core types. (`crates/alef-codegen/src/shared.rs`, `crates/alef-codegen/src/generators/structs.rs`, `crates/alef-codegen/src/conversions/`, `crates/alef-backend-*/src/gen_bindings/`)
